...
class GIF {
    ...
    public function draw(gif_index: Int, x: Float, y: Float, w: Float, h: Float): Void {
        if (Pancake.gifs[gif_index].images[Pancake.gifs[gif_index].frame] != null) {
            Pancake.graphics.drawImage(Pancake.gifs[gif_index].images[Pancake.gifs[gif_index].frame], 0, 0, Pancake.gifs[gif_index].images[Pancake.gifs[gif_index].frame].width, Pancake.gifs[gif_index].images[Pancake.gifs[gif_index].frame].height, x, y, w, h);
